                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        ...
                        <svg class="h-5 w-5 text-green-400" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1.707-5.707a1 1 0 011.414 0L10 12.586l2.293-2.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-1.293-1.293a1 1 010-1.414z" clip-rule="evenodd"/>
                        </svg>
                    </div>
                    <div class="ml-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="relative">
                                ...
                                <button type="button"
                                    ...
                                    <svg id="showPassword" class="h-5 w-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 116 0 3 3 0 01-6 0z" />
                        ...
                        <?php if ($cliente['intentos'] == 3): ?>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="Usuario_bloqueado" type="checkbox" name="Usuario_bloqueado" value="3" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" checked>
                        ...
                        <?php if ($cliente['intentos'] < 3): ?>
                            ...
                            <div class="flex items-center mb-4">
                                <input id="Usuario_bloqueado" type="checkbox" name="Usuario_bloqueado" value="0" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Usuario Bloqueado</label>
                            </div>
